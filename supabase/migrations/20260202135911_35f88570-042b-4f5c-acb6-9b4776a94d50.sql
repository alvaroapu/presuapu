-- Añadir columna metros_gratis a productos
ALTER TABLE public.productos 
ADD COLUMN metros_gratis numeric DEFAULT 0;

-- Actualizar la función de cálculo de precio para considerar metros gratis
...
BEGIN
  ...
  -- Obtener metros gratis del producto
  v_metros_gratis := COALESCE(v_producto.metros_gratis, 0);
  
  -- Calcular cantidad facturable (cantidad - metros gratis, mínimo 0)
